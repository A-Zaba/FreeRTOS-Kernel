...
#define AT91C_AIC_SRCTYPE_INT_LEVEL_SENSITIVE \
    ( 0x0 << 5 ) // (AIC) Internal Sources Code Label Level Sensitive
#define AT91C_AIC_SRCTYPE_INT_EDGE_TRIGGERED \
    ( 0x1 << 5 ) // (AIC) Internal Sources Code Label Edge triggered
#define AT91C_AIC_SRCTYPE_EXT_HIGH_LEVEL \
    ( 0x2 << 5 ) // (AIC) External Sources Code Label High-level Sensitive
#define AT91C_AIC_SRCTYPE_EXT_POSITIVE_EDGE \
    ( 0x3 << 5 ) // (AIC) External Sources Code Label Positive Edge triggered
...
#define AT91C_SYSC_BODIEN \
    ( 0x1 << 16 ) // (RSTC) Brown-out Detection Interrupt Enable
...
#define AT91C_SSC_STTOUT \
    ( 0x1 << 15 ) // (SSC) Receive/Transmit Start Output Selection
...
#define AT91C_TCB_TC0XC0S \
    ( 0x1 << 0 ) // (TCB) External Clock Signal 0 Selection
#define AT91C_TCB_TC0XC0S_TCLK0 ( 0x0 ) // (TCB) TCLK0 connected to XC0
#define AT91C_TCB_TC0XC0S_NONE  ( 0x1 ) // (TCB) None signal connected to XC0
#define AT91C_TCB_TC0XC0S_TIOA1 ( 0x2 ) // (TCB) TIOA1 connected to XC0
#define AT91C_TCB_TC0XC0S_TIOA2 ( 0x3 ) // (TCB) TIOA2 connected to XC0
#define AT91C_TCB_TC1XC1S \
    ( 0x1 << 2 ) // (TCB) External Clock Signal 1 Selection
...
#define AT91C_TCB_TC2XC2S \
    ( 0x1 << 4 ) // (TCB) External Clock Signal 2 Selection
...
#define AT91C_SYSC_SYSC_VRPM \
    ( 0xFFFFFD60 ) // (SYSC) Voltage Regulator Power Mode Register
...
#define AT91C_SPI_TNPR \
    ( 0xFFFE0118 ) // (PDC_SPI) Transmit Next Pointer Register
...
#define AT91C_SPI_TNCR \
    ( 0xFFFE011C ) // (PDC_SPI) Transmit Next Counter Register
...
#define AT91C_PA0_TIOA0 \
    ( AT91C_PIO_PA0 ) //  Timer Counter 0 Multipurpose Timer I/O Pin A
#define AT91C_PIO_PA1  ( 1 << 1 )        // Pin Controlled by PA1
#define AT91C_PA1_PWM1 ( AT91C_PIO_PA1 ) //  PWM Channel 1
#define AT91C_PA1_TIOB0 \
    ( AT91C_PIO_PA1 ) //  Timer Counter 0 Multipurpose Timer I/O Pin B
...
#define AT91C_PA15_TIOA1 \
    ( AT91C_PIO_PA15 ) //  Timer Counter 1 Multipurpose Timer I/O Pin A
#define AT91C_PIO_PA16 ( 1 << 16 )        // Pin Controlled by PA16
#define AT91C_PA16_TK  ( AT91C_PIO_PA16 ) //  SSC Transmit Clock
#define AT91C_PA16_TIOB1 \
    ( AT91C_PIO_PA16 ) //  Timer Counter 1 Multipurpose Timer I/O Pin B
...
#define AT91C_PA4_TCLK0 \
    ( AT91C_PIO_PA4 )                   //  Timer Counter 0 external clock input
