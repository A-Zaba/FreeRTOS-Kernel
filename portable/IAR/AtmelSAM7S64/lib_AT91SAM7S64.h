...
#define AT91C_MC_CORRECT_KEY \
    ( ( unsigned int ) 0x5A << 24 ) // (MC) Correct Protect Key
...
//*----------------------------------------------------------------------------
__inline void AT91F_MC_EFC_CfgModeReg( AT91PS_MC pMC,      // pointer to a MC
                                                           // controller
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_MC_EFC_GetModeReg( AT91PS_MC pMC ) // pointer to a
                                                               // MC controller
{
    return pMC->MC_FMR;
}
...
//* \brief Return MC EFC Mode Regsiter
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_MC_EFC_ComputeFMCN( int master_clock ) // master
                                                                   // clock in
                                                                   // Hz
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_MC_EFC_PerformCmd( AT91PS_MC pMC, // pointer to a MC
                                                      // controller
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_MC_EFC_GetStatus( AT91PS_MC pMC ) // pointer to a MC
                                                              // controller
{
    return pMC->MC_FSR;
}
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_SetNextRx( AT91PS_PDC pPDC, // \arg pointer to a PDC
                                                    // controller
                                   char * address,  // \arg address to the next
                                                    // bloc to be received
                                   unsigned int bytes ) // \arg number of bytes
                                                        // to be received
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_SetNextTx( AT91PS_PDC pPDC, // \arg pointer to a PDC
                                                    // controller
                                   char * address,  // \arg address to the next
                                                    // bloc to be transmitted
                                   unsigned int bytes ) // \arg number of bytes
                                                        // to be transmitted
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_SetRx( AT91PS_PDC pPDC, // \arg pointer to a PDC
                                                // controller
                               char * address,  // \arg address to the next bloc
                                                // to be received
                               unsigned int bytes ) // \arg number of bytes to
                                                    // be received
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_SetTx( AT91PS_PDC pPDC, // \arg pointer to a PDC
                                                // controller
                               char * address,  // \arg address to the next bloc
                                                // to be transmitted
                               unsigned int bytes ) // \arg number of bytes to
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_EnableTx( AT91PS_PDC pPDC ) // \arg pointer to a PDC
                                                    // controller
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_EnableRx( AT91PS_PDC pPDC ) // \arg pointer to a PDC
                                                    // controller
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_DisableTx( AT91PS_PDC pPDC ) // \arg pointer to a PDC
                                                     // controller
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_DisableRx( AT91PS_PDC pPDC ) // \arg pointer to a PDC
                                                     // controller
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PDC_IsNextTxEmpty( // \return return 1 if transfer is
                                      // complete
    AT91PS_PDC pPDC )                 // \arg pointer to a PDC controller
{
...
//* \brief Test if the next transfer descriptor has been moved to the current td
//*----------------------------------------------------------------------------
__inline int AT91F_PDC_IsNextRxEmpty( // \return return 1 if transfer is
                                      // complete
    AT91PS_PDC pPDC )                 // \arg pointer to a PDC controller
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PDC_Close( AT91PS_PDC pPDC ) // \arg pointer to a PDC
                                                 // controller
{
    //* Disable the RX and TX PDC transfer requests
    AT91F_PDC_DisableRx( pPDC );
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_DBGU_GetInterruptMaskStatus( // \return DBGU
                                                         // Interrupt Mask
                                                         // Status
    AT91PS_DBGU pDbgu ) // \arg  pointer to a DBGU controller
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_DBGU_IsInterruptMasked( AT91PS_DBGU pDbgu,  // \arg  pointer
                                                               // to a DBGU
                                                               // controller
                                           unsigned int flag ) // \arg  flag to
                                                               // be tested
{
...
#define AT91C_I2S_ASY_MASTER_TX_SETTING( nb_bit_by_slot, nb_slot_by_frame ) \
    ( +AT91C_SSC_CKS_DIV + AT91C_SSC_CKO_CONTINOUS + AT91C_SSC_CKG_NONE +   \
      AT91C_SSC_START_FALL_RF + AT91C_SSC_STTOUT +                          \
...
#define AT91C_I2S_ASY_TX_FRAME_SETTING( nb_bit_by_slot, nb_slot_by_frame ) \
    ( +( nb_bit_by_slot - 1 ) + AT91C_SSC_MSBF +                           \
...
//*----------------------------------------------------------------------------
__inline void AT91F_SSC_SetBaudrate( AT91PS_SSC pSSC, // \arg pointer to a SSC
                                                      // controller
                                     unsigned int mainClock, // \arg peripheral
                                                             // clock
...
//*----------------------------------------------------------------------------
__inline void AT91F_SSC_EnableRx( AT91PS_SSC pSSC ) // \arg pointer to a SSC
                                                    // controller
{
    //* Enable receiver
...
//*----------------------------------------------------------------------------
__inline void AT91F_SSC_DisableRx( AT91PS_SSC pSSC ) // \arg pointer to a SSC
                                                     // controller
{
    //* Disable receiver
...
//*----------------------------------------------------------------------------
__inline void AT91F_SSC_EnableTx( AT91PS_SSC pSSC ) // \arg pointer to a SSC
                                                    // controller
{
    //* Enable  transmitter
...
//*----------------------------------------------------------------------------
__inline void AT91F_SSC_DisableTx( AT91PS_SSC pSSC ) // \arg pointer to a SSC
                                                     // controller
{
    //* Disable  transmitter
...
//* \brief Enable SSC IT
//*----------------------------------------------------------------------------
__inline void AT91F_SSC_EnableIt( AT91PS_SSC pSSC,    // \arg pointer to a SSC
                                                      // controller
...
//*----------------------------------------------------------------------------
__inline void AT91F_SSC_DisableIt( AT91PS_SSC pSSC,    // \arg pointer to a SSC
                                                       // controller
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_SSC_GetInterruptMaskStatus( // \return SSC Interrupt
                                                        // Mask Status
    AT91PS_SSC pSsc ) // \arg  pointer to a SSC controller
{
    return pSsc->SSC_IMR;
...
//*----------------------------------------------------------------------------
__inline int AT91F_SSC_IsInterruptMasked( AT91PS_SSC pSsc, // \arg  pointer to a
                                                           // SSC controller
                                          unsigned int flag ) // \arg  flag to
                                                              // be tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_SPI_EnableIt( AT91PS_SPI pSPI,    // pointer to a SPI
                                                      // controller
...
//*----------------------------------------------------------------------------
__inline void AT91F_SPI_DisableIt( AT91PS_SPI pSPI,    // pointer to a SPI
                                                       // controller
...
//*----------------------------------------------------------------------------
__inline void AT91F_SPI_Close( AT91PS_SPI pSPI ) // \arg pointer to a SPI
                                                 // controller
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_SPI_GetInterruptMaskStatus( // \return SPI Interrupt
                                                        // Mask Status
...
//*----------------------------------------------------------------------------
__inline int AT91F_SPI_IsInterruptMasked( AT91PS_SPI pSpi, // \arg  pointer to a
                                                           // SPI controller
                                          unsigned int flag ) // \arg  flag to
                                                              // be tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PWMC_InterruptEnable( AT91PS_PWMC pPwm, // \arg  pointer to
                                                            // a PWM controller
                                          unsigned int flag ) // \arg  PWM
                                                              // interrupt to be
                                                              // enabled
{
    pPwm->PWMC_IER = flag;
...
//*----------------------------------------------------------------------------
__inline void AT91F_PWMC_InterruptDisable( AT91PS_PWMC pPwm, // \arg  pointer to
                                                             // a PWM controller
                                           unsigned int flag ) // \arg  PWM
                                                               // interrupt to
                                                               // be disabled
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PWMC_GetInterruptMaskStatus( // \return PWM
                                                         // Interrupt Mask
                                                         // Status
...
//* \brief Test if PWM Interrupt is Set
//*----------------------------------------------------------------------------
__inline void AT91F_PWMC_CfgChannel( AT91PS_PWMC pPWM, // \arg  pointer to a PWM
                                                       // controller
                                     unsigned int channelId, // \arg PWM channel
                                                             // ID
...
//*----------------------------------------------------------------------------
__inline void AT91F_PWMC_StartChannel( AT91PS_PWMC pPWM,   // \arg  pointer to a
                                                           // PWM controller
                                       unsigned int flag ) // \arg  Channels IDs
                                                           // to be enabled
{
    pPWM->PWMC_ENA = flag;
}
...
//*----------------------------------------------------------------------------
__inline void AT91F_PWMC_StopChannel( AT91PS_PWMC pPWM,   // \arg  pointer to a
                                                          // PWM controller
                                      unsigned int flag ) // \arg  Channels IDs
                                                          // to be enabled
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_TC_InterruptEnable( AT91PS_TC pTc, // \arg  pointer to a TC
                                                       // controller
                                        unsigned int flag ) // \arg  TC
                                                            // interrupt to be
                                                            // enabled
{
    pTc->TC_IER = flag;
...
//*----------------------------------------------------------------------------
__inline void AT91F_TC_InterruptDisable( AT91PS_TC pTc, // \arg  pointer to a TC
                                                        // controller
                                         unsigned int flag ) // \arg  TC
                                                             // interrupt to be
                                                             // disabled
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_TC_GetInterruptMaskStatus( // \return TC Interrupt
                                                       // Mask Status
...
//*----------------------------------------------------------------------------
__inline int AT91F_TC_IsInterruptMasked( AT91PS_TC pTc, // \arg  pointer to a TC
                                                        // controller
                                         unsigned int flag ) // \arg  flag to be
                                                             // tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PMC_CfgSysClkEnableReg( AT91PS_PMC pPMC, // \arg pointer to
                                                             // PMC controller
                                            unsigned int mode )
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PMC_CfgSysClkDisableReg( AT91PS_PMC pPMC, // \arg pointer to
                                                              // PMC controller
                                             unsigned int mode )
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PMC_GetPeriphClock( AT91PS_PMC pPMC ) // \arg
                                                                  // pointer to
                                                                  // PMC
                                                                  // controller
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_CKGR_CfgMainOscillatorReg( AT91PS_CKGR pCKGR, // \arg
                                                                  // pointer to
                                                                  // CKGR
                                                                  // controller
                                               unsigned int mode )
...
//*----------------------------------------------------------------------------
__inline void AT91F_CKGR_EnableMainOscillator( AT91PS_CKGR pCKGR ) // \arg
                                                                   // pointer to
                                                                   // CKGR
                                                                   // controller
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PMC_CfgMCKReg( AT91PS_PMC pPMC, // \arg pointer to PMC
                                                    // controller
                                   unsigned int mode )
{
    pPMC->PMC_MCKR = mode;
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PMC_GetMCKReg( AT91PS_PMC pPMC ) // \arg pointer to
                                                             // PMC controller
{
    ...
    unsigned int slowClock ) // \arg slowClock in Hz
{
    ...
    switch( reg & AT91C_PMC_CSS )
    {
        ...
        case AT91C_PMC_CSS_PLL_CLK: // PLLB clock is selected
            ...
            return AT91F_CKGR_GetMainClock( pCKGR, slowClock ) / pllDivider *
...
//* \brief Enable peripheral clock
//*----------------------------------------------------------------------------
__inline void AT91F_PMC_EnablePCK( AT91PS_PMC pPMC,  // \arg pointer to PMC
                                                     // controller
                                   unsigned int pck, // \arg Peripheral clock
                                                     // identifier 0 .. 7
                                   unsigned int mode )
{
...
//* \brief Enable peripheral clock
//*----------------------------------------------------------------------------
__inline void AT91F_PMC_DisablePCK( AT91PS_PMC pPMC,   // \arg pointer to PMC
                                                       // controller
                                    unsigned int pck ) // \arg Peripheral clock
                                                       // identifier 0 .. 7
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PMC_EnableIt( AT91PS_PMC pPMC,    // pointer to a PMC
                                                      // controller
                                  unsigned int flag ) // IT to be enabled
{
    //* Write to the IER register
...
//*----------------------------------------------------------------------------
__inline void AT91F_PMC_DisableIt( AT91PS_PMC pPMC,    // pointer to a PMC
                                                       // controller
                                   unsigned int flag ) // IT to be disabled
{
    //* Write to the IDR register
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PMC_GetInterruptMaskStatus( // \return PMC Interrupt
                                                        // Mask Status
    AT91PS_PMC pPMC ) // pointer to a PMC controller
{
    return pPMC->PMC_IMR;
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PMC_IsStatusSet( AT91PS_PMC pPMC, // \arg  pointer
                                                              // to a PMC
                                                              // controller
                                             unsigned int flag ) // \arg  flag
                                                                 // to be tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_EnableIt( AT91PS_ADC pADC,    // pointer to a ADC
                                                      // controller
                                  unsigned int flag ) // IT to be enabled
{
    //* Write to the IER register
...
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_DisableIt( AT91PS_ADC pADC,    // pointer to a ADC
                                                       // controller
                                   unsigned int flag ) // IT to be disabled
{
    //* Write to the IDR register
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_ADC_GetInterruptMaskStatus( // \return ADC Interrupt
                                                        // Mask Status
    AT91PS_ADC pADC ) // pointer to a ADC controller
{
    return pADC->ADC_IMR;
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_ADC_IsStatusSet( AT91PS_ADC pADC, // \arg  pointer
                                                              // to a ADC
                                                              // controller
                                             unsigned int flag ) // \arg  flag
                                                                 // to be tested
...
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_CfgModeReg( AT91PS_ADC pADC,    // pointer to a ADC
                                                        // controller
                                    unsigned int mode ) // mode register
{
    //* Write to the MR register
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_ADC_GetModeReg( AT91PS_ADC pADC // pointer to a ADC
                                                            // controller
)
{
    return pADC->ADC_MR;
...
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_CfgTimings( AT91PS_ADC pADC,        // pointer to a ADC
                                                            // controller
                                    ...
                                    unsigned int sample_and_hold_time ) // in ns
{
    ...
    //* Write to the MR register
    pADC->ADC_MR = ( ( prescal << 8 ) & AT91C_ADC_PRESCAL ) |
...
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_EnableChannel( AT91PS_ADC pADC, // pointer to a ADC
                                                        // controller
...
//* \brief Return ADC Timer Register Value
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_DisableChannel( AT91PS_ADC pADC, // pointer to a ADC
                                                         // controller
                                        unsigned int channel ) // mode register
{
...
//* \brief Return ADC Timer Register Value
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_ADC_GetChannelStatus( AT91PS_ADC pADC // pointer to
                                                                  // a ADC
                                                                  // controller
)
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_StartConversion( AT91PS_ADC pADC // pointer to a ADC
                                                         // controller
)
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_ADC_SoftReset( AT91PS_ADC pADC // pointer to a ADC
                                                   // controller
)
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_CfgPeriph( AT91PS_PIO pPio, // \arg pointer to a PIO
                                                    // controller
                                   unsigned int periphAEnable,  // \arg PERIPH A
                                                                // to enable
                                   unsigned int periphBEnable ) // \arg PERIPH B
                                                                // to enable
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_CfgOutput( AT91PS_PIO pPio, // \arg pointer to a PIO
                                                    // controller
                                   unsigned int pioEnable ) // \arg PIO to be
                                                            // enabled
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_CfgInput( AT91PS_PIO pPio, // \arg pointer to a PIO
                                                   // controller
                                  unsigned int inputEnable ) // \arg PIO to be
                                                             // enabled
{
    // Disable output
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_CfgPullup( AT91PS_PIO pPio, // \arg pointer to a PIO
                                                    // controller
                                   unsigned int pullupEnable ) // \arg enable
                                                               // pullup on PIO
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsInputSet( AT91PS_PIO pPio,    // \arg  pointer to a PIO
                                                       // controller
                                   unsigned int flag ) // \arg  flag to be
                                                       // tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_SetOutput( AT91PS_PIO pPio,    // \arg  pointer to a PIO
                                                       // controller
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_ClearOutput( AT91PS_PIO pPio, // \arg  pointer to a PIO
                                                      // controller
                                     unsigned int flag ) // \arg  output to be
                                                         // cleared
{
    pPio->PIO_CODR = flag;
}
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_ForceOutput( AT91PS_PIO pPio, // \arg  pointer to a PIO
                                                      // controller
                                     unsigned int flag ) // \arg  output to be
                                                         // forced
{
...
//* \brief Enable PIO
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_Enable( AT91PS_PIO pPio,    // \arg  pointer to a PIO
                                                    // controller
...
//* \brief Disable PIO
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_Disable( AT91PS_PIO pPio,    // \arg  pointer to a PIO
                                                     // controller
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsSet( AT91PS_PIO pPio,    // \arg  pointer to a PIO
                                                  // controller
                              unsigned int flag ) // \arg  flag to be tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_OutputEnable( AT91PS_PIO pPio, // \arg  pointer to a PIO
                                                       // controller
                                      unsigned int flag ) // \arg  pio output to
                                                          // be enabled
{
    pPio->PIO_OER = flag;
}
...
//* \brief Output Enable PIO
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_OutputDisable( AT91PS_PIO pPio,    // \arg  pointer to a
                                                           // PIO controller
                                       unsigned int flag ) // \arg  pio output
                                                           // to be disabled
{
    pPio->PIO_ODR = flag;
}
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsOutputSet( AT91PS_PIO pPio, // \arg  pointer to a PIO
                                                     // controller
                                    unsigned int flag ) // \arg  flag to be
                                                        // tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_InputFilterEnable( AT91PS_PIO pPio, // \arg  pointer to
                                                            // a PIO controller
                                           unsigned int flag ) // \arg  pio
                                                               // input filter
                                                               // to be enabled
{
    pPio->PIO_IFER = flag;
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_GetInputFilterStatus( // \return PIO Input
                                                      // Filter Status
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsInputFilterSet( AT91PS_PIO pPio, // \arg  pointer to a
                                                          // PIO controller
                                         unsigned int flag ) // \arg  flag to be
                                                             // tested
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_GetOutputDataStatus( // \return PIO Output Data
                                                     // Status
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_InterruptEnable( AT91PS_PIO pPio, // \arg  pointer to a
                                                          // PIO controller
                                         unsigned int flag ) // \arg  pio
                                                             // interrupt to be
                                                             // enabled
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_InterruptDisable( AT91PS_PIO pPio, // \arg  pointer to a
                                                           // PIO controller
                                          unsigned int flag ) // \arg  pio
                                                              // interrupt to be
                                                              // disabled
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_GetInterruptMaskStatus( // \return PIO Interrupt
                                                        // Mask Status
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
    return pPio->PIO_IMR;
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_GetInterruptStatus( // \return PIO Interrupt
                                                    // Status
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
    return pPio->PIO_ISR;
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsInterruptMasked( AT91PS_PIO pPio, // \arg  pointer to a
                                                           // PIO controller
                                          unsigned int flag ) // \arg  flag to
                                                              // be tested
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsInterruptSet( AT91PS_PIO pPio,    // \arg  pointer to a
                                                           // PIO controller
                                       unsigned int flag ) // \arg  flag to be
                                                           // tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_MultiDriverEnable( AT91PS_PIO pPio, // \arg  pointer to
                                                            // a PIO controller
                                           unsigned int flag ) // \arg  pio to
                                                               // be enabled
{
    pPio->PIO_MDER = flag;
}
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_MultiDriverDisable( AT91PS_PIO pPio, // \arg  pointer to
                                                             // a PIO controller
                                            unsigned int flag ) // \arg  pio to
                                                                // be disabled
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_GetMultiDriverStatus( // \return PIO Multi
                                                      // Driver Status
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsMultiDriverSet( AT91PS_PIO pPio, // \arg  pointer to a
                                                          // PIO controller
                                         unsigned int flag ) // \arg  flag to be
                                                             // tested
{
...
//* \brief Return PIO Interrupt Status
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_Get_AB_RegisterStatus( // \return PIO AB
                                                       // Register Status
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsAB_RegisterSet( AT91PS_PIO pPio, // \arg  pointer to a
                                                          // PIO controller
                                         unsigned int flag ) // \arg  flag to be
                                                             // tested
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_PIO_OutputWriteEnable( AT91PS_PIO pPio, // \arg  pointer to
                                                            // a PIO controller
                                           unsigned int flag ) // \arg  pio
                                                               // output write
                                                               // to be enabled
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_GetOutputWriteStatus( // \return PIO Output
                                                      // Write Status
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsOutputWriteSet( AT91PS_PIO pPio, // \arg  pointer to a
                                                          // PIO controller
                                         unsigned int flag ) // \arg  flag to be
                                                             // tested
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_PIO_GetCfgPullup( // \return PIO Configuration
                                              // Pullup
    AT91PS_PIO pPio ) // \arg  pointer to a PIO controller
{
...
//*----------------------------------------------------------------------------
__inline int AT91F_PIO_IsCfgPullupStatusSet( AT91PS_PIO pPio, // \arg  pointer
                                                              // to a PIO
                                                              // controller
                                             unsigned int flag ) // \arg  flag
                                                                 // to be tested
...
//* \brief Enable TWI IT
//*----------------------------------------------------------------------------
__inline void AT91F_TWI_EnableIt( AT91PS_TWI pTWI,    // \arg pointer to a TWI
                                                      // controller
                                  unsigned int flag ) // \arg IT to be enabled
{
    //* Write to the IER register
...
//*----------------------------------------------------------------------------
__inline void AT91F_TWI_DisableIt( AT91PS_TWI pTWI,    // \arg pointer to a TWI
                                                       // controller
                                   unsigned int flag ) // \arg IT to be disabled
{
    //* Write to the IDR register
...
//*----------------------------------------------------------------------------
__inline void AT91F_TWI_Configure( AT91PS_TWI pTWI ) // \arg pointer to a TWI
                                                     // controller
{
    //* Disable interrupts
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_TWI_GetInterruptMaskStatus( // \return TWI Interrupt
                                                        // Mask Status
...
//*----------------------------------------------------------------------------
__inline int AT91F_TWI_IsInterruptMasked( AT91PS_TWI pTwi, // \arg  pointer to a
                                                           // TWI controller
                                          unsigned int flag ) // \arg  flag to
                                                              // be tested
{
...
#define AT91C_US_ASYNC_SCK_MODE                                            \
    ( AT91C_US_USMODE_NORMAL + AT91C_US_NBSTOP_1_BIT + AT91C_US_PAR_NONE + \
      AT91C_US_CHRL_8_BITS + AT91C_US_CLKS_EXT )

//* Standard Synchronous Mode : 8 bits , 1 stop , no parity
#define AT91C_US_SYNC_MODE                                             \
    ( AT91C_US_SYNC + AT91C_US_USMODE_NORMAL + AT91C_US_NBSTOP_1_BIT + \
...
#define AT91C_US_ISO_READER_MODE                                         \
    ( AT91C_US_USMODE_ISO7816_0 + AT91C_US_CLKS_CLOCK +                  \
      AT91C_US_NBSTOP_1_BIT + AT91C_US_PAR_EVEN + AT91C_US_CHRL_8_BITS + \
      AT91C_US_CKLO + AT91C_US_OVER )

//* Standard IRDA mode
#define AT91C_US_ASYNC_IRDA_MODE                                         \
    ( AT91C_US_USMODE_IRDA + AT91C_US_NBSTOP_1_BIT + AT91C_US_PAR_NONE + \
      AT91C_US_CHRL_8_BITS + AT91C_US_CLKS_CLOCK )
...
//* \brief Set the baudrate according to the CPU clock
//*----------------------------------------------------------------------------
__inline void AT91F_US_SetBaudrate( AT91PS_USART pUSART,    // \arg pointer to a
                                                            // USART controller
                                    unsigned int mainClock, // \arg peripheral
                                                            // clock
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_SetTimeguard( AT91PS_USART pUSART, // \arg pointer to a
                                                          // USART controller
                                     unsigned int timeguard ) // \arg timeguard
                                                              // value
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_EnableIt( AT91PS_USART pUSART, // \arg pointer to a USART
                                                      // controller
                                 unsigned int flag )  // \arg IT to be enabled
{
    //* Write to the IER register
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_DisableIt( AT91PS_USART pUSART, // \arg pointer to a
                                                       // USART controller
                                  unsigned int flag )  // \arg IT to be disabled
{
    //* Write to the IER register
    ...
    unsigned int timeguard ) // \arg timeguard to be programmed
{
    ...
    //* Reset receiver and transmitter
    pUSART->US_CR = AT91C_US_RSTRX | AT91C_US_RSTTX | AT91C_US_RXDIS |
                    AT91C_US_TXDIS;
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_EnableRx( AT91PS_USART pUSART ) // \arg pointer to a
                                                       // USART controller
{
    //* Enable receiver
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_EnableTx( AT91PS_USART pUSART ) // \arg pointer to a
                                                       // USART controller
{
    //* Enable  transmitter
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_ResetRx( AT91PS_USART pUSART ) // \arg pointer to a USART
                                                      // controller
{
    //* Reset receiver
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_ResetTx( AT91PS_USART pUSART ) // \arg pointer to a USART
                                                      // controller
{
    //* Reset transmitter
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_DisableRx( AT91PS_USART pUSART ) // \arg pointer to a
                                                        // USART controller
{
    //* Disable receiver
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_DisableTx( AT91PS_USART pUSART ) // \arg pointer to a
                                                        // USART controller
{
    //* Disable transmitter
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_Close( AT91PS_USART pUSART ) // \arg pointer to a USART
                                                    // controller
{
    ...
    //* Disable receiver and transmitter and stop any activity immediately
    pUSART->US_CR = AT91C_US_TXDIS | AT91C_US_RXDIS | AT91C_US_RSTTX |
                    AT91C_US_RSTRX;
}
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_US_TxReady( AT91PS_USART pUSART ) // \arg pointer to
                                                              // a USART
                                                              // controller
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_US_RxReady( AT91PS_USART pUSART ) // \arg pointer to
                                                              // a USART
                                                              // controller
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_US_Error( AT91PS_USART pUSART ) // \arg pointer to a
                                                            // USART controller
{
...
//* \brief Send a character,does not check if ready to send
//*----------------------------------------------------------------------------
__inline void AT91F_US_PutChar( AT91PS_USART pUSART, int character )
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_US_SetIrdaFilter( AT91PS_USART pUSART, unsigned char value )
{
    pUSART->US_IF = value;
}
...
//* \brief Enable UDP IT
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_EnableIt( AT91PS_UDP pUDP,    // \arg pointer to a UDP
                                                      // controller
                                  unsigned int flag ) // \arg IT to be enabled
{
    //* Write to the IER register
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_DisableIt( AT91PS_UDP pUDP,    // \arg pointer to a UDP
                                                       // controller
                                   unsigned int flag ) // \arg IT to be disabled
{
    //* Write to the IDR register
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_SetAddress( AT91PS_UDP pUDP, // \arg pointer to a UDP
                                                     // controller
                                    unsigned char address ) // \arg new UDP
                                                            // address
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_EnableEp( AT91PS_UDP pUDP,    // \arg pointer to a UDP
                                                      // controller
                                  unsigned int flag ) // \arg endpoints to be
                                                      // enabled
{
...
//* \brief Enable Endpoint
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_DisableEp( AT91PS_UDP pUDP,    // \arg pointer to a UDP
                                                       // controller
                                   unsigned int flag ) // \arg endpoints to be
                                                       // enabled
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_SetState( AT91PS_UDP pUDP,    // \arg pointer to a UDP
                                                      // controller
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_EpStall( AT91PS_UDP pUDP, // \arg pointer to a UDP
                                                  // controller
                                 unsigned char endpoint ) // \arg endpoint
                                                          // number
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_EpWrite( AT91PS_UDP pUDP, // \arg pointer to a UDP
                                                  // controller
                                 unsigned char endpoint, // \arg endpoint number
                                 unsigned char value )   // \arg value to be
                                                         // written in the DPR
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_UDP_EpRead( AT91PS_UDP pUDP, // \arg pointer to a
                                                         // UDP controller
                                        unsigned char endpoint ) // \arg
                                                                 // endpoint
                                                                 // number
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_EpEndOfWr( AT91PS_UDP pUDP, // \arg pointer to a UDP
                                                    // controller
                                   unsigned char endpoint ) // \arg endpoint
                                                            // number
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_EpClear( AT91PS_UDP pUDP, // \arg pointer to a UDP
                                                  // controller
                                 unsigned char endpoint, // \arg endpoint number
...
//*----------------------------------------------------------------------------
__inline void AT91F_UDP_EpSet( AT91PS_UDP pUDP,        // \arg pointer to a UDP
                                                       // controller
                               unsigned char endpoint, // \arg endpoint number
                               unsigned int flag ) // \arg flag to be cleared
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_UDP_EpStatus( AT91PS_UDP pUDP, // \arg pointer to a
                                                           // UDP controller
                                          unsigned char endpoint ) // \arg
                                                                   // endpoint
                                                                   // number
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_UDP_GetInterruptMaskStatus( // \return UDP Interrupt
                                                        // Mask Status
    AT91PS_UDP pUdp ) // \arg  pointer to a UDP controller
{
    return pUdp->UDP_IMR;
...
//*----------------------------------------------------------------------------
__inline int AT91F_UDP_IsInterruptMasked( AT91PS_UDP pUdp, // \arg  pointer to a
                                                           // UDP controller
                                          unsigned int flag ) // \arg  flag to
                                                              // be tested
{
...
/* *****************************************************************************
   ...
   *****************************************************************************
 */
#define AT91C_AIC_BRANCH_OPCODE \
    ( ( void ( * )() ) 0xE51FFF20 ) // ldr, pc, [pc, #-&F20]
...
//*----------------------------------------------------------------------------
__inline void AT91F_AIC_EnableIt( AT91PS_AIC pAic, // \arg pointer to the AIC
                                                   // registers
...
//*----------------------------------------------------------------------------
__inline void AT91F_AIC_DisableIt( AT91PS_AIC pAic, // \arg pointer to the AIC
                                                    // registers
...
//*----------------------------------------------------------------------------
__inline void AT91F_AIC_ClearIt( AT91PS_AIC pAic, // \arg pointer to the AIC
                                                  // registers
                                 unsigned int irq_id ) // \arg interrupt number
                                                       // to initialize
{
...
//*----------------------------------------------------------------------------
__inline void AT91F_AIC_AcknowledgeIt( AT91PS_AIC pAic ) // \arg pointer to the
                                                         // AIC registers
{
...
//* \brief Trig an IT
//*----------------------------------------------------------------------------
__inline void AT91F_AIC_Trig( AT91PS_AIC pAic,      // \arg pointer to the AIC
                                                    // registers
                              unsigned int irq_id ) // \arg interrupt number
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_AIC_IsActive( AT91PS_AIC pAic, // \arg pointer to
                                                           // the AIC registers
                                          unsigned int irq_id ) // \arg
                                                                // Interrupt
                                                                // Number
{
...
//*----------------------------------------------------------------------------
__inline unsigned int AT91F_AIC_IsPending( AT91PS_AIC pAic, // \arg pointer to
                                                            // the AIC registers
                                           unsigned int irq_id ) // \arg
                                                                 // Interrupt
                                                                 // Number
...
__inline void AT91F_DBGU_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ( ( unsigned int ) AT91C_PA10_DTXD ) |
                             ( ( unsigned int ) AT91C_PA9_DRXD ), // Peripheral
                                                                  // A
                         0 ); // Peripheral B
}
...
__inline void AT91F_PWMC_CH3_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ...
                         ( ( unsigned int ) AT91C_PA14_PWM3 ) |
                             ( ( unsigned int ) AT91C_PA7_PWM3 ) ); // Peripheral
                                                                    // B
}
...
__inline void AT91F_SPI_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ( ( unsigned int ) AT91C_PA11_NPCS0 ) |
                             ...
                             ( ( unsigned int ) AT91C_PA14_SPCK ), // Peripheral
                                                                   // A
...
__inline void AT91F_PMC_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ...
                         ( ( unsigned int ) AT91C_PA17_PCK1 ) |
                             ...
                             ( ( unsigned int ) AT91C_PA6_PCK0 ) ); // Peripheral
                                                                    // B
}
...
__inline void AT91F_TWI_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ( ( unsigned int ) AT91C_PA3_TWD ) |
                             ( ( unsigned int ) AT91C_PA4_TWCK ), // Peripheral
                                                                  // A
                         0 ); // Peripheral B
}
...
__inline void AT91F_US1_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ( ( unsigned int ) AT91C_PA21_RXD1 ) |
                             ...
                             ( ( unsigned int ) AT91C_PA25_CTS1 ), // Peripheral
                                                                   // A
                         0 ); // Peripheral B
}
...
__inline void AT91F_US0_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ( ( unsigned int ) AT91C_PA5_RXD0 ) |
                             ...
                             ( ( unsigned int ) AT91C_PA8_CTS0 ), // Peripheral
                                                                  // A
...
__inline void AT91F_AIC_CfgPIO( void )
{
    ...
    AT91F_PIO_CfgPeriph( AT91C_BASE_PIOA, // PIO controller base address
                         ...
                         ( ( unsigned int ) AT91C_PA20_IRQ0 ) |
                             ( ( unsigned int ) AT91C_PA19_FIQ ) ); // Peripheral
                                                                    // B
}
